...
def process_config(config):
    ...
    exp_name = config.exp_name + '{}_{}_{}_bs{}_lr{}_wd{}_temp_{}'.format(config.method, config.dataset,config.model_arch, config.batch_size, config.lr, config.wd, config.temp)
